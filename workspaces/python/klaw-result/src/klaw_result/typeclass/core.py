...
__all__ = ["typeclass", "TypeClass", "NoInstanceError"]
...
class TypeClass(wrapt.ObjectProxy, Generic[F]):
    ...
    def __init__(self, default_fn: F) -> None:
        ...
        self._self_default: F | None = (
            default_fn if _has_implementation(default_fn) else None
        )
    ...
    def __repr__(self) -> str:
        types_registered = list(self._self_instances.keys()) + list(
            self._self_generic_instances.keys()
        )
