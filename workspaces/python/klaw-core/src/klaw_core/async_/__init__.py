...
Example:
    ```python
    from klaw_core.async_ import AsyncResult, async_collect
...
from klaw_core.async_.cache import async_lru_safe
from klaw_core.async_.itertools import (
    async_collect,
...
from klaw_core.async_.result import AsyncResult
