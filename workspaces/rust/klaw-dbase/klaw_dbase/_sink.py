...
from ._dbase_rs import write_dbase_buff, write_dbase_file, EmptySources
...
def write_dbase(
    ...
    *,
    ...
    Example:
        ...
        # Write a DataFrame to a dBase file with a custom encoding
        ```python
            import polars as pl
            from klaw_dbase import write_dbase
        ...
        # Write a DataFrame to a dBase file with a custom overwrite
        ```python
            import polars as pl
            from klaw_dbase import write_dbase
        ...
        # Write a DataFrame to a dBase file with a custom memo threshold
        ```python
            import polars as pl
            from klaw_dbase import write_dbase
